...
class TestPythonIO:
    ...
    def test_component_info(self):
        ...
        assert comp_info.include_pattern == comp_desc[json_fields.COMPONENT_DESC_INCLUDE_GLOB_PATTERNS]
        assert comp_info.exclude_pattern == comp_desc[json_fields.COMPONENT_DESC_EXCLUDE_GLOB_PATTERNS]
